            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  ...
                  <center>
                    <span class="d-none d-lg-block">Pelaporan Pengaduan Masyarakat</span>
                  </center>
                </a>
              </div><!-- End Logo -->
              <?php 
              if (isset($_GET['pesan'])){
                ...
                <div class="card mb-3">
                  ...
                  <div class="card-body">
                    ...
                    <form class="row g-3 needs-validation" novalidate action="proses_login.php" method="post">
                      ...
                      <div class="col-12">
                        <p class="small mb-0">Tidak punya akun? <a href="reg.php">Buat Akun</a></p>
                      </div>
                    </form>
